...
if ( function_exists( 'get_post_gallery_images' ) ) :
	...
	if ( isset( $atts['ids'] ) ) :
		$the_bootstrap_images = explode( ',', $atts['ids'] );
	endif;
endif;

if ( ! $the_bootstrap_images ) :
	$the_bootstrap_images = get_posts( array(
		'fields'         => 'ids',
		'numberposts'    => 999,
		'order'          => 'ASC',
		'orderby'        => 'menu_order',
	...
	<div class="entry-content row">
		...
		<div id="gallery-slider" class="carousel slide span5">
			...
			<div class="carousel-inner">
				...
				<figure class="item">
					<?php echo wp_get_attachment_image( $the_bootstrap_image, array( 470, 353 ) );
					if ( has_excerpt( $the_bootstrap_image ) ) :?>
					<figcaption class="carousel-caption">
						<h4><?php echo get_the_title( $the_bootstrap_image ); ?></h4>
						<p><?php echo apply_filters( 'get_the_excerpt', get_post( $the_bootstrap_image )->post_excerpt ); ?></p>
					</figcaption>
					<?php endif; ?>
				</figure>
				<?php endforeach; ?>
